angular.module('easypoll')
    ...
    .directive('angledNavbar',function(){
        return {
            ...
            templateUrl : 'client/easypoll/directives/navbar/navbar.ng.html',
            controller : ['$scope','$element','$attrs',function($scope,$element,$attrs){
                 ...
                 * @result  boolean
                 */
                $scope.hasRightMenus = function(){
                    return (angular.isDefined($attrs.rightmenus));
                };
                ...
                $scope.hasDropdownRightMenu = function(menu){
                    return (angular.isDefined(menu.menu) && angular.isArray(menu.menu));
                };
